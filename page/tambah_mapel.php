...
if (isset($_POST['tambah'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO mapel VALUES ('$kd_mapel','$nm_mapel','$kd_guru','$kkm')")
                ...
                <div class="card-body p-2">
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kkm" id="nm_mapel" placeholder="KKM" class="form-control">
                        </div>
